...
//#include "Enumerations/EAttachmentRule"
...
public:	
	...
	void ChangeWeaponType(TSubclassOf<AABaseWeapon> NewWeaponType);
	...
	UFUNCTION(BlueprintCallable, Category = "BirdOfPrey")
	void GATakeDamage(float DamageAmount, float& ActualDamage );
	//TakeDamage namingini APawn class'ý kullanýyordu, o yüzden GATakeDamage yaptým. 
	...
	//UPROPERTY(BlueprintReadWrite, Category = "BirdOfPrey")
	//EAttachmentRuleType WeaponAttachRule; bu attach actor to component'ýn promote to variable'ý, nasýl
	// include yapacaðýmý çözemedim.
